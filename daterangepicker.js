...
(function(root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string')
            options.template = '<div class="daterangepicker dropdown-menu"> <div class="row"> <div class="col-md-4 col-xs-12"> <div class="ranges"> <div class="range_inputs"> <button class="applyBtn" disabled="disabled" type="button"></button> <button class="cancelBtn" type="button"></button> </div> </div> </div> <div class="col-md-4 col-xs-12"> <div class="calendar left"> <div class="calendar-table"></div> <div class="daterangepicker_input"> <input class="input-mini" type="text" name="daterangepicker_start" value="" /> <i class="fa fa-calendar glyphicon glyphicon-calendar"></i> <div class="calendar-time"> <div></div> <i class="fa fa-clock-o glyphicon glyphicon-time"></i> </div> </div> </div> </div> <div class="col-md-4 col-xs-12"> <div class="calendar right"> <div class="calendar-table"></div> <div class="daterangepicker_input"> <input class="input-mini" type="text" name="daterangepicker_end" value="" /> <i class="fa fa-calendar glyphicon glyphicon-calendar"></i> <div class="calendar-time"> <div></div> <i class="fa fa-clock-o glyphicon glyphicon-time"></i> </div> </div> </div> </div> </div> </div>';
    ...
    DateRangePicker.prototype = {
        ...
        formInputsChanged: function(e) {
            ...
            var check = this.container.find('input[name="daterangepicker_end"]').val().split('/');
            ...
            if (start.isValid() && end.isValid() && lengthCheck()) {
